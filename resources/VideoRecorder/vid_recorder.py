...
def main(session):
    ...
    vid_recorder_service.startRecording("/home/nao/Logs/Video/Top/", "vid")

    # This records a 320*240 MJPG video at 10 fps.
    # Note MJPG can't be recorded with a framerate lower than 3 fps.
    vid_recorder_service.setCameraId(0)
    vid_recorder_service.setResolution(0)
    vid_recorder_service.setFrameRate(10)
    vid_recorder_service.setVideoFormat("MJPG")
    vid_recorder_service.startRecording("/home/nao/Logs/Video/Bottom/", "vid")
