/**
 * @file Simulator/JointsEnum.h
 *
 * This file declares the Enumeration Ids for all the sensors and 
 * actuators as provided in the naoqi. 
 * FIXME: Needs to be the same as in
 * ControlModule/HardwareIds.h
 * The problem is in Naoqi's sensor list.
 *
