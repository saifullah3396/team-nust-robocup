...
RobotExtraction::processImage()
{
...
#endif
  strayRegions.clear();
  //PRINT("Refreshing robot regions...")
  refreshRobotRegions();
  //PRINT("Filtering robot region lines...")
  filterLinesBelowField();
  //PRINT("Finding robot regions...")
  findRobotRegions();
  //PRINT("Classifying robots...")
  classifyRobots();
  //PRINT("Robot regions size: " << outputRegions.size())
  ...
  //PRINT("RobotExtraction.Update.Time: " << timeSpan.count() << " seconds.")
#endif
