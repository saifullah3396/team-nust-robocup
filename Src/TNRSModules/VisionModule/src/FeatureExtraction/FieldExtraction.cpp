...
FieldExtraction::processImage()
{
  ...
  //PRINT("FieldExtraction.FilterPoints.Time: " << timeSpan.count() << " seconds.");
  ...
  //PRINT("FieldExtraction.RANSAC.Time: " << timeSpan.count() << " seconds.");
  tStart = high_resolution_clock::now();
#endif
  ...
  //tEnd = high_resolution_clock::now();
  //timeSpan = tEnd - tStart; 
  //PRINT("FieldExtraction.Transform.Time: " << timeSpan.count() << " seconds.");
  //tStart = high_resolution_clock::now();
  ...
  //tEnd = high_resolution_clock::now();
  //timeSpan = tEnd - tStart; 
  //PRINT("FieldExtraction.borderLines.Time: " << timeSpan.count() << " seconds.");
#endif
