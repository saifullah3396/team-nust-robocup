...
protected:
  ...
  // ---------------------------------------------------                          
  std::string
  create_tmpfile(std::ofstream &tmp);
  ...
  // ---------------------------------------------------------------------------------                                  
  bool
  file_available(const std::string &filename);
  ...
  // ---------------------------------------------------------------------------------                                  
  static bool
  file_exists(const std::string &filename, int mode = 0);
...
public:
  ...
  // ----------------------------------------------------------------------------
  static bool
  set_GNUPlotPath(const std::string &path);
  ...
  // ----------------------------------------------------------------------------
  static void
  set_terminal_std(const std::string &type);
  ...
  Gnuplot(const std::vector<double> &x, const std::vector<double> &y,
    const std::string &title = "", const std::string &labelx = "x",
    const std::string &labely = "y", const std::string &style = "points");

  /// plot triples std::vector at one go
  Gnuplot(const std::vector<double> &x, const std::vector<double> &y,
    const std::vector<double> &z, const std::string &title = "",
    const std::string &labelx = "x", const std::string &labely = "y",
    const std::string &labelz = "z", const std::string &style = "points");
  ...
  // ---------------------------------------------------------------------------------
  inline Gnuplot&
  operator<<(const std::string &cmdstr)
  {
    cmd(cmdstr);
    return (*this);
  }
  ...
  Gnuplot&
  showonscreen(); // window output is set by default (win/x11/aqua)

  /// saves a gnuplot session to a postscript file, filename without extension
  Gnuplot&
  savetops(const std::string &filename = "gnuplot_output");
  ...
  Gnuplot&
  set_style(const std::string &stylestr = "points");
  ...
  Gnuplot&
  set_pointsize(const double pointsize = 1.0);
  ...
  ///  base, surface, both
  Gnuplot&
  set_contour(const std::string &position = "base");
  // --------------------------------------------------------------------------
  ...
  Gnuplot&
  set_legend(const std::string &position = "default");
  ...
  /// set x axis label
  Gnuplot&
  set_ylabel(const std::string &label = "x");
  /// set y axis label
  Gnuplot&
  set_xlabel(const std::string &label = "y");
  /// set z axis label
  Gnuplot&
  set_zlabel(const std::string &label = "z");

  /// set axis - ranges
  Gnuplot&
  set_xrange(const double iFrom, const double iTo);
  /// set y-axis - ranges
  Gnuplot&
  set_yrange(const double iFrom, const double iTo);
  /// set z-axis - ranges
  Gnuplot&
  set_zrange(const double iFrom, const double iTo);
  ...
  Gnuplot&
  set_cbrange(const double iFrom, const double iTo);
  ...
  ///   from file
  Gnuplot&
  plotfile_x(const std::string &filename, const unsigned int column = 1,
    const std::string &title = "");
  ///   from std::vector
  template<typename X>
    Gnuplot&
    plot_x(const X& x, const std::string &title = "");

  /// plot x,y pairs: x y
  ///   from file
  Gnuplot&
  plotfile_xy(const std::string &filename, const unsigned int column_x = 1,
    const unsigned int column_y = 2, const std::string &title = "");
  ///   from data
  template<typename X, typename Y>
    Gnuplot&
    plot_xy(const X& x, const Y& y, const std::string &title = "");

  /// plot x,y pairs with dy errorbars: x y dy
  ///   from file
  Gnuplot&
  plotfile_xy_err(const std::string &filename, const unsigned int column_x = 1,
    const unsigned int column_y = 2, const unsigned int column_dy = 3,
    const std::string &title = "");
  ///   from data
  template<typename X, typename Y, typename E>
    Gnuplot&
    plot_xy_err(const X &x, const Y &y, const E &dy, const std::string &title =
      "");

  /// plot x,y,z triples: x y z
  ///   from file
  Gnuplot&
  plotfile_xyz(const std::string &filename, const unsigned int column_x = 1,
    const unsigned int column_y = 2, const unsigned int column_z = 3,
    const std::string &title = "");
  ///   from std::vector
  template<typename X, typename Y, typename Z>
    Gnuplot&
    plot_xyz(const X &x, const Y &y, const Z &z, const std::string &title = "");

  /// plot an equation of the form: y = ax + b, you supply a and b
  Gnuplot&
  plot_slope(const double a, const double b, const std::string &title = "");
  ...
  Gnuplot&
  plot_equation(const std::string &equation, const std::string &title = "");
  ...
  Gnuplot&
  plot_equation3d(const std::string &equation, const std::string &title = "");

  /// plot image
  Gnuplot&
  plot_image(const unsigned char *ucPicBuf, const unsigned int iWidth,
    const unsigned int iHeight, const std::string &title = "");
...
//
inline
Gnuplot::Gnuplot(const std::vector<double> &x, const std::string &title,
...
//
inline
Gnuplot::Gnuplot(const std::vector<double> &x, const std::vector<double> &y,
  const std::string &title, const std::string &labelx,
  const std::string &labely, const std::string &style) :
  gnucmd(NULL), valid(false), two_dim(false), nplots(0)
{
  init();
...
Gnuplot::Gnuplot(const std::vector<double> &x, const std::vector<double> &y,
  const std::vector<double> &z, const std::string &title,
  const std::string &labelx, const std::string &labely,
  const std::string &labelz, const std::string &style) :
  gnucmd(NULL), valid(false), two_dim(false), nplots(0)
{
  init();
...
//
void
Gnuplot::set_terminal_std(const std::string &type)
{
#if defined(unix) || defined(__unix) || defined(__unix__) || defined(__APPLE__)
  if (type.find("x11") != std::string::npos &&
    type.find("qt") != std::string::npos &&
    type.find("wxt") != std::string::npos &&
    getenv("DISPLAY") == NULL)
  {
    ...
    const char * const delimiters = " \t\n")
  {
    ...
    while (i < len) {
      ...
      if (j == std::string::npos) {
        ...
        return;
      } else container.push_back(in.substr(i, j - i));
...
//
Gnuplot&
Gnuplot::set_style(const std::string &stylestr)
{
  if (stylestr.find("lines") == std::string::npos && stylestr.find("points") == std::string::npos && stylestr.find(
    "linespoints") == std::string::npos && stylestr.find("impulses") == std::string::npos && stylestr.find(
    "dots") == std::string::npos && stylestr.find("steps") == std::string::npos && stylestr.find(
    "fsteps") == std::string::npos && stylestr.find("histeps") == std::string::npos && stylestr.find(
    "boxes") == std::string::npos && // 1-4 columns of data are required
  stylestr.find("filledcurves") == std::string::npos && stylestr.find(
    "histograms") == std::string::npos) //only for one data column
...
//
Gnuplot&
Gnuplot::set_smooth(const std::string &stylestr)
{
  if (stylestr.find("unique") == std::string::npos && stylestr.find("frequency") == std::string::npos && stylestr.find(
    "csplines") == std::string::npos && stylestr.find("acsplines") == std::string::npos && stylestr.find(
    "bezier") == std::string::npos && stylestr.find("sbezier") == std::string::npos) {
    smooth = "";
  } else {
    smooth = stylestr;
  }
...
//
Gnuplot&
Gnuplot::savetops(const std::string &filename)
{
...
//
Gnuplot&
Gnuplot::set_legend(const std::string &position)
{
  std::ostringstream cmdstr;
...
//
Gnuplot&
Gnuplot::set_xlogscale(const double base)
{
  std::ostringstream cmdstr;
...
//
Gnuplot&
Gnuplot::set_ylogscale(const double base)
{
  std::ostringstream cmdstr;
...
//
Gnuplot&
Gnuplot::set_zlogscale(const double base)
{
  std::ostringstream cmdstr;
...
//
Gnuplot&
Gnuplot::set_pointsize(const double pointsize)
{
  std::ostringstream cmdstr;
...
//
Gnuplot&
Gnuplot::set_samples(const int samples)
{
  std::ostringstream cmdstr;
...
//
Gnuplot&
Gnuplot::set_isosamples(const int isolines)
{
  std::ostringstream cmdstr;
...
Gnuplot&
Gnuplot::set_contour(const std::string &position)
{
  if (position.find("base") == std::string::npos && position.find("surface") == std::string::npos && position.find(
...
// set the xlabel
Gnuplot&
Gnuplot::set_xlabel(const std::string &label)
{
  std::ostringstream cmdstr;
...
//
Gnuplot&
Gnuplot::set_ylabel(const std::string &label)
{
  std::ostringstream cmdstr;
...
//
Gnuplot&
Gnuplot::set_zlabel(const std::string &label)
{
  std::ostringstream cmdstr;
...
Gnuplot::plot_slope(const double a, const double b, const std::string &title)
{
  ...
  //
  if (nplots > 0 && two_dim == true) cmdstr << "replot ";
  else cmdstr << "plot ";

  cmdstr << a << " * x + " << b << " title \"";

  if (title == "") cmdstr << "f(x) = " << a << " * x + " << b;
  else cmdstr << title;
...
Gnuplot::plot_equation3d(const std::string &equation, const std::string &title)
{
  ...
  // command to be sent to gnuplot
  //
  if (nplots > 0 && two_dim == false) cmdstr << "replot ";
  else cmdstr << "splot ";

  cmdstr << equation << " title \"";

  if (title == "") cmdstr << "f(x,y) = " << equation;
  else cmdstr << title;
...
//
Gnuplot&
Gnuplot::plotfile_x(const std::string &filename, const unsigned int column,
  const std::string &title)
{
  //
  ...
  if (title == "") cmdstr << " notitle ";
  else cmdstr << " title \"" << title << "\" ";

  if (smooth == "") cmdstr << "with " << pstyle;
  else cmdstr << "smooth " << smooth;
...
//
Gnuplot&
Gnuplot::plotfile_xy(const std::string &filename, const unsigned int column_x,
  const unsigned int column_y, const std::string &title)
{
  //
  // check if file exists
  //
...
Gnuplot::plotfile_xy_err(const std::string &filename,
  ...
  const unsigned int column_dy, const std::string &title)
{
  //
  // check if file exists
  //
  ...
  cmdstr << "\"" << filename << "\" using " << column_x << ":" << column_y << ":" << column_dy << " with errorbars ";
...
//
Gnuplot&
Gnuplot::plotfile_xyz(const std::string &filename, const unsigned int column_x,
  const unsigned int column_y, const unsigned int column_z,
  const std::string &title)
{
  //
  // check if file exists
  ...
  if (title == "") cmdstr << " notitle with " << pstyle;
  else cmdstr << " title \"" << title << "\" with " << pstyle;
  ...
  const unsigned int iHeight, const std::string &title)
{
  ...
  if (title == "") cmdstr << "\"" << name << "\" with image";
  else cmdstr << "\"" << name << "\" title \"" << title << "\" with image";
...
Gnuplot::get_program_path()
{
  ...
  if (path == NULL) {
    ...
    tmp =
      "Can't find gnuplot neither in PATH nor in \"" + Gnuplot::m_sGNUPlotPath + "\"";
...
//
bool
Gnuplot::file_exists(const std::string &filename, int mode)
{
  if (mode < 0 || mode > 7) {
...
bool
Gnuplot::file_available(const std::string &filename)
{
...
//
std::string
Gnuplot::create_tmpfile(std::ofstream &tmp)
{
  ...
  if (Gnuplot::tmpfile_num == GP_MAX_TMP_FILES - 1) {
    std::ostringstream except;
    except << "Maximum number of temporary files reached (" << GP_MAX_TMP_FILES << "): cannot open more files" << std::endl;
