...
template<typename X>
  Gnuplot&
  Gnuplot::plot_x(const std::vector<X>& x, const std::string &title)
  {
    if (x.size() == 0) {
...
template<typename X, typename Y>
  Gnuplot&
  Gnuplot::plot_xy(const std::vector<X>& x, const std::vector<Y>& y, const std::string &title)
  {
...
template Gnuplot& Gnuplot::plot_xy<float, float>(
  const std::vector<float>&, const std::vector<float>&, const std::string&);
template Gnuplot& Gnuplot::plot_xy<double, double>(
  const std::vector<double>&, const std::vector<double>&, const std::string&);
...
template<typename X, typename Y, typename E>
  Gnuplot&
  Gnuplot::plot_xy_err(const std::vector<X>& x, const std::vector<Y>& y, const std::vector<E> &dy,
...
template Gnuplot& Gnuplot::plot_xy_err<float, float, float>(
  const std::vector<float>&, const std::vector<float>&, const std::vector<float>&, const std::string&);
template Gnuplot& Gnuplot::plot_xy_err<double, double, double>(
  const std::vector<double>&, const std::vector<double>&, const std::vector<double>&, const std::string&);
...
template<typename X, typename Y, typename Z>
  Gnuplot&
  Gnuplot::plot_xyz(const std::vector<X>& x, const std::vector<Y>& y, const std::vector<Z>& z,
    const std::string &title)
  {
...
template Gnuplot& Gnuplot::plot_xyz<float, float, float>(
  const std::vector<float>&, const std::vector<float>&, const std::vector<float>&, const std::string&);
template Gnuplot& Gnuplot::plot_xyz<double, double, double>(
  const std::vector<double>&, const std::vector<double>&, const std::vector<double>&, const std::string&);
